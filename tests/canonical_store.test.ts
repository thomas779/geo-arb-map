...
describe('canonical SQL import and projections', () => {
  ...
  test('derives queryable route and coverage projections from SQL', () => {
    ...
    expect(projections.coverage.map(row => row.iso_n3)).toEqual([
      '028', '032', '036', '044', '052', '068', '076', '100', '124', '136', '152',
      '158', '170', '196', '212', '218', '250', '268', '276', '300', '308', '348',
      '360', '372', '376', '380', '392', '400', '410', '458', '470', '480', '484',
      '520', '528', '548', '554', '566', '591', '600', '604', '608', '616', '620',
      '659', '662', '678', '688', '702', '710', '724', '756', '764', '784', '792',
      '818', '826', '840', '858',
    ]);
