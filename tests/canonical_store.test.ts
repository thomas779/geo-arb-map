...
describe('canonical SQL import and projections', () => {
  ...
  test('derives queryable route and coverage projections from SQL', () => {
    ...
    expect(projections.coverage.map(row => row.iso_n3)).toEqual([
      '028', '032', '036', '044', '052', '076', '100', '124', '136', '152', '170',
      '196', '212', '250', '268', '276', '300', '308', '348', '372', '376', '380',
      '392', '400', '410', '470', '480', '484', '520', '528', '548', '554', '591',
      '600', '608', '616', '620', '659', '662', '678', '688', '702', '710', '724',
      '756', '784', '792', '818', '826', '840', '858',
    ]);
